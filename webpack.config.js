...
var website ={
    publicPath:"http://localhost:8888/"  //上线后可以将这个变量替换output里的publicPath
...
module.exports = {
    ...
    plugins: [
        ...
        new HtmlWebpackPlugin({
            template: path.resolve(__dirname,'src','index.html'), //在这个页面的基础上将打包的js，css文件放进去
            filename:'index.html',
            chunks:['index', 'vendor'], //只加载想引入的 即entry的key值 与之相对应的是excludeChunks
            title: 'I am is perfect!',
            hash:true,//防止缓存
            minify:{
        ...
        new webpack.HotModuleReplacementPlugin() //热更新设置1
    ],
    ...
    devServer: {
        ...
        host: 'localhost',
        overlay: true,
        inline: true,  //实时刷新 热更新 设置2
        hot: true, //hot module replacement. Depends on HotModuleReplacementPlugin设置3
        compress: false // 服务器返回浏览器的时候是否启动gzip压缩 //服务端压缩是否开启
    },
